...
function triggerReactButton(button){manualIdle=false;if(startButton?.disabled&&button===startButton){setWorkshopState("ready",{apiRequired:true});return}button?.dispatchEvent(new MouseEvent("click",{bubbles:true,cancelable:true,view:window}))}
