...
export const WebFileManager: FileManagerPluginDef = {
  ...
  async buildPatchedApk() { notAvailable("buildPatchedApk") },
  async installApk() { notAvailable("installApk") },
  async uninstallAndInstallApk() { notAvailable("uninstallAndInstallApk") },
  async uninstallApk() { notAvailable("uninstallApk") },
  async openAppSettings() { notAvailable("openAppSettings") },
  async launchApp() { notAvailable("launchApp") },
  async loadTranslationCache() { notAvailable("loadTranslationCache") },
  async saveTranslationCache() { notAvailable("saveTranslationCache") },
  async getApkPackageName() { notAvailable("getApkPackageName") },
